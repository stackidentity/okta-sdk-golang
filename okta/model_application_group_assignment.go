...
func (o *ApplicationGroupAssignment) GetProfile() *GroupProfile {
...
// and a boolean to check if the value has been set.
func (o *ApplicationGroupAssignment) GetProfileOk() (*GroupProfile, bool) {
	if o == nil || o.Profile == nil {
		return nil, false
	}
...
func (o *ApplicationGroupAssignment) SetProfile(v *GroupProfile) {
	o.Profile = v
}
